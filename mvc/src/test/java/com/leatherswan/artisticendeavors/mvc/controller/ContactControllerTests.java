...
import com.leatherswan.artisticendeavors.jpa.model.validators.ContactFormValidator;
...
import com.leatherswan.artisticendeavors.mvc.MvcTestUtil;
...
public class ContactControllerTests extends AbstractContext {
    ...
    public void setUp() {
        ...
        mockMvc = standaloneSetup(mockController)
