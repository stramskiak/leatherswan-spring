...
import com.leatherswan.artisticendeavors.mvc.security.WithAdminUser;
import com.leatherswan.artisticendeavors.mvc.security.WithPostUser;
...
import static com.leatherswan.artisticendeavors.mvc.controller.PostsController.*;
import static com.leatherswan.artisticendeavors.mvc.security.SecurityRequestPostProcessors.csrf;
...
public class PostsControllerTests extends AbstractContext {
    ...
    private static final String GOOD_URL = "http://leatherswan.com/java/dysfunctional-enumerated-annotations-in-hibernate/";
    ...
    public void homePageTest() throws Exception {
        final ResultActions resultActions = mockMvc.perform(get("/posts"))
