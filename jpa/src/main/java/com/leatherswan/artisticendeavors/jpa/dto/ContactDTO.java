...
public class ContactDTO {
    ...
    private ContactBioDTO contactBioDTO;
    ...
    public ContactBioDTO getContactBioDTO() {
        return contactBioDTO;
    }

    public void setContactBioDTO(ContactBioDTO contactBioDTO) {
        this.contactBioDTO = contactBioDTO;
    }
    ...
    public void setCategories(Set<CategoryDTO> genres) {
