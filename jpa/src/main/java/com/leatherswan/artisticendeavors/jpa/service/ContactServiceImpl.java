...
import com.leatherswan.artisticendeavors.jpa.repository.*;
...
//        return Lists.newArrayList(contactRepository.findAll());
    ...
    @Override
    public ContactBio addContactBio(ContactBioDTO contactBioDTO) {
        return null;
    }

    @Override
    public ContactBio findContactBioById(Long contactBioId) {
        return contactBioRepository.findOne(contactBioId);
    }

    @Override
    public ContactBio deleteContactBioById(Long contactBioId) throws ContactNotFoundException {
        ContactBio contactBio = contactBioRepository.findOne(contactBioId);
    ...
    @Override
    public List<Product> findContactProductByContactId(Long contactId) {
        return null;
    }

    @Override
    public Product addContactProduct(ProductDTO productDTO) {
        return null;
    }

    @Override
    public Product findContactProductById(Long contactProductID) {
        return null;
    }

    @Override
    public Product deleteContactProductById(Long contactProductId) throws ContactNotFoundException {
        return null;
    }
